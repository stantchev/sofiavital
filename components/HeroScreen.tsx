...
// Static import — types provided by types/animejs.d.ts
...
export default function HeroScreen({ onEnter }: Props) {
  ...
  useEffect(() => {
    ...
    headingRef.current.innerHTML = words
      .map(
        (w) =>
          `<span class="hero-word" style="display:inline-block;opacity:0;transform:translateY(28px)">${w}&nbsp;</span>`
      )
      .join("");
  ...
  return (
    <div
      style={{
        ...
        inset: 0,
        background:
          "radial-gradient(ellipse 80% 60% at 50% 30%, #091c38 0%, #03070f 65%)",
        display: "flex",
    ...
    >
      ...
      <div
        style={{
          ...
          maskImage:
            "radial-gradient(ellipse 80% 80% at 50% 50%, black 0%, transparent 80%)",
          WebkitMaskImage:
            "radial-gradient(ellipse 80% 80% at 50% 50%, black 0%, transparent 80%)",
        }}
      />
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            cursor: "pointer",
            boxShadow:
              "0 0 48px rgba(52,211,153,0.25), 0 4px 20px rgba(0,0,0,0.5)",
            opacity: 0,
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.boxShadow =
              "0 0 64px rgba(52,211,153,0.35), 0 8px 24px rgba(0,0,0,0.5)";
          }}
          onMouseLeave={(e) => {
